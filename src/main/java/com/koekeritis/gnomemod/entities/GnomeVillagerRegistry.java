package com.koekeritis.gnomemod.entities;
...
import com.koekeritis.gnomemod.world.gen.structure.MushroomVillagePieces;
import com.koekeritis.gnomemod.world.gen.structure.MushroomVillagePieces.PieceWeight;
import com.koekeritis.gnomemod.world.gen.structure.MushroomVillagePieces.Start;
 ...
 *
 */
public class GnomeVillagerRegistry
{
    private static final GnomeVillagerRegistry INSTANCE = new GnomeVillagerRegistry();
    ...
    public interface IVillageCreationHandler
    {
         ...
         * @param p5
         */
        Object buildComponent(PieceWeight villagePiece, Start startPiece, @SuppressWarnings("rawtypes") List pieces, Random random, int p1,
    ...
    public static GnomeVillagerRegistry instance()
    {
        return INSTANCE;
    }
    ...
    public static Object getVillageComponent(MushroomVillagePieces.PieceWeight villagePiece, MushroomVillagePieces.Start startPiece, @SuppressWarnings("rawtypes") List pieces, Random random,
