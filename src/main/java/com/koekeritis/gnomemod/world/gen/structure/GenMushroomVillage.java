...
public class GenMushroomVillage extends MapGenStructure
{
    /** A list of all the biomes villages can spawn in. */
    public static List villageSpawnBiomes = Arrays.asList(new BiomeGenBase[] {BiomeGenBase.plains, BiomeGenBase.roofedForest, BiomeGenBase.forest, BiomeGenBase.birchForest});
    ...
    public GenMushroomVillage()
    {
        this.field_82665_g = 32;
        this.field_82666_h = 8;
    }

    public GenMushroomVillage(Map p_i2093_1_)
    {
        this();
    ...
    {
        return new GenMushroomVillage.Start(this.worldObj, this.rand, p_75049_1_, p_75049_2_, this.terrainType);
    }
