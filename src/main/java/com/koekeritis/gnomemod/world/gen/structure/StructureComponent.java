...
public abstract class StructureComponent
{
    ...
    {
        if (GnomeModMapGenStructureIO.func_143036_a(this) == null) // Friendlier error then the Null Stirng error below.
        {
        ...
        nbttagcompound.setString("id", GnomeModMapGenStructureIO.func_143036_a(this));
